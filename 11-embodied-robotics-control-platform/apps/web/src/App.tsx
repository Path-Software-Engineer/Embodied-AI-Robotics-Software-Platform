import { Activity, AlertTriangle, Box, Boxes, Clock3, Database, Radio, RotateCcw, ShieldCheck } from 'lucide-react'
  ...
  return (
    <div className="app-shell">
      <aside className="sidebar" aria-label="Navegación de la plataforma">
        ...
        <nav aria-label="Módulos"><a className="nav-item active" href="#observatory"><Activity size={18} aria-hidden="true" />Observatorio<span>01</span></a><a className="nav-item" href="#control"><ShieldCheck size={18} aria-hidden="true" />Control<span>02</span></a><a className="nav-item" href="#architecture"><Boxes size={18} aria-hidden="true" />Arquitectura<span>03</span></a></nav>
