...
- Render, ROS loop and DB ingestion under concurrency have not been profiled; the local HTTP latency smoke does not substitute for those measurements. The web build still warns about a large JavaScript chunk.
